...
var _self = {},
	...
	_self.startRead = function (codeFound, errorFound, canvasID, successStart) {
		...
		if ( canvasID !== null ) {
			...
			frameAvailableCallback = frameAvailable;
			window.webworks.event.add(_ID, "community.barcodescanner.frameavailable", frameAvailableCallback);
		}
	...
	_self.stopRead = function (successfulEnd, errorFound) {
		...
		if ( canvas !== null ) {
			frameAvailableCallback = frameAvailable;
			window.webworks.event.remove(_ID, "community.barcodescanner.frameavailable", frameAvailableCallback);
		}
	...
	var codefoundCallback, errorfoundCallback, frameAvailableCallback;
